...
be transformed into gesture sequences, and transition matrices.
Transition matrices have been used as a visualisation technique to
reveal qualitative differences in structure in improvisational
music-making\cite{Swift:2014tya}. In this paper, however, we wish to
extract quantitative measures from these TMs for comparing and
