...
% While musical interactions such as those in
% our corpus are often analysed using qualitative methods, it is
% problematic to 
...
% need to add overall contrasts column to do pairwise t-tests.
...
\begin{figure}
  ...
  \caption{Distribution flux values of sessions through time.
