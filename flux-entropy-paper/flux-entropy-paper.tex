...
In our corpus, the median length of sessions is 7m26s (IS THIS STILL THE MEDIAN IGNORING THE
DEMONSTRATION AND DATA GATHERING SESSIONS?) and the median
...
Because it has been
established that musical performances on touch-screens can be chuncked into
vocabularies of continuous macro gestures that unfold over
several seconds of touch interaction~\cite{Martin:2014cr}, these logs
 can be thought of as a sequence of such
...
($F(1,86) = 25.86$) (WHAT IS THE P VALUE HERE?). There was no main effect for session type although
