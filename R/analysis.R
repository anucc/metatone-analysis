...
ggplot(df, aes(performance_context, entropy)) + geom_boxplot()
...
summary(aov(flux~performance_context*performance_type, reh.perf.studies.df))
summary(aov(entropy~performance_context*performance_type, reh.perf.studies.df))

ggplot(reh.perf.studies.df,aes(performance_type,entropy)) + geom_boxplot()
